            ...
            <div class="lg:max-w-lg">
              ...
              <dl class="mt-10 max-w-xl space-y-8 text-base leading-7 text-gray-600 lg:max-w-none">
                <div class="relative pl-9">
                  ...
                  <dd class="inline">
                   Aprendé habilidades que el mercado realmente busca, sin perder tiempo en teoría innecesaria.
                  </dd>
                </div>
                <div class="relative pl-9">
                  <dt class="inline font-semibold text-gray-900">
                ...
                <div class="relative pl-9">
                  ...
                  <dd class="inline">
                  Recibí feedback de expertos y construí un portfolio profesional mientras estudiás.
                  </dd>
                </div>
              </dl>
            </div>
